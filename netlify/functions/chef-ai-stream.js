// The Chef – KI-Streaming. Wie chef-ai.js, aber Claudes SSE-Stream wird 1:1
// an den Client durchgereicht: erster Token nach ~400ms statt 2-3s voller
// Roundtrip. Netlify Functions v2 (export default + Response) fuer echtes
// Response-Streaming ohne Buffer.
//
// Erwartet POST mit JSON (gleiches Schema wie chef-ai.js):
//   { message, history, restaurant, context }
// Antwort: text/event-stream mit Anthropic-Events; Client liest
...
export default async (req) => {
  ...
  // History normalisieren (identisch zu chef-ai.js: alternierend, defensiv)
  ...
  // Claudes SSE 1:1 durchreichen -- kein Buffer, kein Umpacken
